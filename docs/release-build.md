...
code 5; the account-form contract and submission-feedback fix in rc5 uses version code 6.
...
copies `GDAD-BAGS-0.2.0-rc5-6-release.apk` to the project root and prints only its path, byte size,
