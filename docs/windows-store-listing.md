...
GDAD BAGS helps a bag shop manage daily sales, purchases, inventory, vendors, and an owner dashboard
from one secure workspace.

Owners can record negotiated selling prices for each sale, post purchase bills manually or import
the supported Excel purchase template, track FIFO stock cost and vendor dues, and review a trusted
daily dashboard. Sales staff receive role-appropriate access for day-to-day selling without owner
administration controls.

The Windows application uses the same protected Supabase business data and accounting rules as the
GDAD BAGS Android application. Financial postings require an internet connection and fail safely
without changing hosted data when the connection is unavailable.

### Product features

1. Flexible per-sale pricing for bargaining workflows
2. FIFO inventory cost and cost-based gross-profit reporting
3. Product, stock, vendor, purchase, and sale management
4. Excel purchase-bill import with automatic product creation and a review step
5. Automatic receipt details for manually posted purchases
6. Owner and Salesman role-based access
7. Nepal-focused dates, currency display, and a trusted daily dashboard
8. Secure hosted authentication and tenant-scoped shop data
9. Online-only financial posting with safe retry behavior

### Short description

Sales, inventory, purchases, vendors, and a trusted owner dashboard for GDAD BAGS.
...
GDAD BAGS ले झोला पसलको दैनिक बिक्री, खरिद, मौज्दात, आपूर्तिकर्ता र पसलधनीको ड्यासबोर्ड एउटै सुरक्षित
प्रणालीबाट व्यवस्थापन गर्न मद्दत गर्छ।

पसलधनीले प्रत्येक बिक्रीमा मोलमोलाइअनुसार फरक मूल्य राख्न, खरिद बिल हातैले पोस्ट गर्न वा समर्थित
Excel खरिद टेम्प्लेट आयात गर्न, FIFO लागतअनुसार मौज्दात र आपूर्तिकर्ताको बाँकी रकम हेर्न तथा दैनिक
ड्यासबोर्ड समीक्षा गर्न सक्छन्। बिक्री कर्मचारीले प्रशासनिक अधिकारबिना आफ्नो भूमिकाअनुसार दैनिक बिक्री
काम गर्न सक्छन्।
...
3. सामान, मौज्दात, आपूर्तिकर्ता, खरिद र बिक्री व्यवस्थापन
4. Excel खरिद बिल आयात, स्वतः सामान सिर्जना र पोस्ट गर्नुअघि समीक्षा
5. हातैले पोस्ट गरिएको खरिदको स्वतः बिल विवरण
6. पसलधनी र बिक्री कर्मचारीका छुट्टाछुट्टै अधिकार
7. नेपालअनुकूल मिति, मुद्रा र विश्वसनीय दैनिक ड्यासबोर्ड
8. सुरक्षित लगइन र पसलअनुसार छुट्टिएको क्लाउड डाटा
9. आर्थिक कारोबारका लागि अनलाइन जडान र सुरक्षित पुनःप्रयास

### Short description

GDAD BAGS का लागि बिक्री, मौज्दात, खरिद, आपूर्तिकर्ता र विश्वसनीय पसलधनी ड्यासबोर्ड।
...
- Recommended first set: login screen, Owner dashboard, product catalogue, flexible-price sale
  entry, and Excel purchase preview.
...
- The Store privacy declaration must be `Yes`. Use the public policy at
