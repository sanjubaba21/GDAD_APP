...
### `products` — Implemented through `20260911090000`
...
- **Fields:** name, display SKU, optional barcode, generated NFKC/space/case-normalized
  comparison codes, suggested/default selling price, minimum negotiated selling price,
...
- **Mutation/audit:** Owner-only idempotent `manage_product` RPC validates a nonnegative minimum
  price no greater than the suggestion; permanent private code
