...
$expectedVersionName = "0.2.0-rc2"
$expectedSha256 = "E63E96ACECFD7D410802E3D371101BD6BB4FBFDC1DDDBC0E29366803230327FC"
...
if (-not $ApkPath) {
    $ApkPath = Join-Path $root "GDAD-BAGS-0.2.0-rc2-3-release.apk"
}
