...
$expectedVersionName = "0.2.0-rc5"
$expectedSha256 = "A565DDCA7B2A09D785E4C9B046A569C55007011AE8D2E4BFF9F13AB3649E2398"
...
if (-not $ApkPath) {
    $ApkPath = Join-Path $root "GDAD-BAGS-0.2.0-rc5-6-release.apk"
}
