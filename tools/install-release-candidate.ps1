...
$expectedVersionName = "0.2.0-rc12"
$expectedSha256 = "0056F8A3099F69C4FCCB157C599C3369E8AFCCFD901B3AB381C3F4C3D895DBEA"
...
if (-not $ApkPath) {
    $ApkPath = Join-Path $root "GDAD-BAGS-0.2.0-rc12-13-release.apk"
}
