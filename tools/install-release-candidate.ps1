...
$expectedVersionName = "0.2.0-rc7"
$expectedSha256 = "52BF20F3F83D7AD8E39A2B84CD1090DF7D2934E071032B011650A40A927992FC"
...
if (-not $ApkPath) {
    $ApkPath = Join-Path $root "GDAD-BAGS-0.2.0-rc7-8-release.apk"
}
