...
$expectedVersionName = "0.2.0-rc4"
$expectedSha256 = "2BC25CA27EA802B0B4291AF24FEE092D906E8E5A8A79E53BDF3AA5578CF13DA8"
...
if (-not $ApkPath) {
    $ApkPath = Join-Path $root "GDAD-BAGS-0.2.0-rc4-5-release.apk"
}
