...
$expectedVersionName = "0.2.0-rc13"
$expectedSha256 = "A1F3E6D9311D91A8650F256C3EBE9B4243ED9A6B7F1BB113790BCBF7D992FC47"
...
if (-not $ApkPath) {
    $ApkPath = Join-Path $root "GDAD-BAGS-0.2.0-rc13-14-release.apk"
}
